 ...
 */
public class PostgresDBManagerImpl implements DBManager {
    ...
    public enum scripts {
        ...
        scripts(final String scriptFileName) {
            this.filePath = "src/main/resources/db/scripts/postgres/" + scriptFileName.toString();
        }
    }
    ...
    public PostgresDBManagerImpl(ConnectionInfo connectionInfo) {
